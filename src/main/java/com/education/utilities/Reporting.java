...
public class Reporting extends TestListenerAdapter{
	...
	public void onTestFailure(ITestResult tr ){
		...
		// Capture screenshot
		TakesScreenshot ts = (TakesScreenshot) basecl.driver ;
		File source = ts.getScreenshotAs(OutputType.FILE);

		String screenshotPath = System.getProperty("user.dir") + "/failReporScreenshots/" + tr.getMethod().getMethodName() + System.currentTimeMillis() + ".jpg";
